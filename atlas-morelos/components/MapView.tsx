...
const PRIMARY_GEOJSON_URL = 'https://raw.githubusercontent.com/memolugo/DashboardATD/main/MorelosgeosonEPSG4326.geojson';
...
const MapView: React.FC<MapViewProps> = ({ markers, selectedMarkerId, onMarkerClick, isLoading }) => {
  ...
  // Color único institucional para todos los marcadores según solicitud
  ...
  return (
    <div className="w-full h-full relative">
      ...
      {/* Se eliminó la leyenda por solicitud del usuario */}
    </div>
  );
};
